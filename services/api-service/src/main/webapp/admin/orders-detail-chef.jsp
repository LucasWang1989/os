												...
												<div class="table-responsive order-list card-table">
													<table class="table items-table table-responsive-md">
														...
														<tr>
															<td>
																<div class="media">
																	<a href="ecom-product-detail.html"><img class="mr-3 img-fluid rounded" src="/assets/<%=wait2CookOrderProduct.getImagePath()%>" alt="DexignZone" width="87px" height="87px"></a>
