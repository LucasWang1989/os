...
<html lang="en">
	...
	<%
		List<ProductModel> wait2CookOrderProducts = (List<ProductModel>)request.getAttribute("orderProducts");
	%>
						...
						<div class="d-flex mb-3 mb-lg-4 align-items-center">
							<div class="mr-auto d-none d-lg-block">
								<div class="d-flex flex-wrap align-items-center">
									<h3 class="text-black font-w600 mb-0 fs-28 mr-5">#<%=wait2CookOrderProducts.size() == 0? "No Orders Available": wait2CookOrderProducts.get(0).getOrderNo()%></h3>
									<input id="orderNoInput" type="hidden" value="<%=wait2CookOrderProducts.size() == 0? "": wait2CookOrderProducts.get(0).getOrderNo()%>">
									<div class="d-flex">
										<a class="mb-0 text-black font-w600 fs-22" href="#">/ Table Number: <%=wait2CookOrderProducts.size() == 0? "0": wait2CookOrderProducts.get(0).getTableNo()%> </a>
									</div>
								</div>
							</div>
											...
											<div class="card-body p-0">
												<div class="table-responsive order-list card-table">
													<table class="table items-table table-responsive-md">
														...
														<%
															for (ProductModel wait2CookOrderProduct : wait2CookOrderProducts) {
																BigInteger totalPrice = wait2CookOrderProduct.getDishNumber()
																		.multiply(wait2CookOrderProduct.getPrice()).divide(new BigInteger("100"));
														%>
														<tr>
															<td>
																<div class="media">
																	<a href="ecom-product-detail.html"><img class="mr-3 img-fluid rounded" src="/customer/<%=wait2CookOrderProduct.getImagePath()%>" alt="DexignZone" width="87px" height="87px"></a>
																	<div class="media-body">
																		<small class="mt-0 mb-1 font-w500"><a class="text-primary" href="javascript:void(0);">MAIN COURSE</a></small>
																		<h5 class="mt-0 mb-2 mb-sm-3"><a class="text-black" href="ecom-product-detail.html"><%=wait2CookOrderProduct.getName()%></a></h5>
															...
															<td>
																<h4 class="my-0  font-w600"><%=wait2CookOrderProduct.getDishNumber()%>x</h4>
															</td>
															<td>
																<h4 class="my-0  font-w600">$<%=wait2CookOrderProduct.getPrice().divide(new BigInteger("100"))%></h4>
															</td>
...
<%--															</td>--%>
									...
									<div class="col-xl-12" <%=wait2CookOrderProducts.size() == 0? "style=\"display: none\"": ""%>>
										<div class="card">
